...
#define APP_ADV_INTERVAL                 600                                        /**< The advertising interval (in units of 0.625 ms. This value corresponds to 25 ms). */
...
APP_TIMER_DEF(m_blinky_timer_id);                                                  /**< Battery timer. */
